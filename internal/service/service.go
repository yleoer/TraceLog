...
func (s *Service) ListTimeWorkItems(ctx context.Context) ([]TimeWorkItem, error) {
	_ = ctx
...
func (s *Service) GetTimeWeek(ctx context.Context, week string) (TimeWeekView, error) {
	return s.getTimeWeek(ctx, week, false)
}

func (s *Service) RefreshTimeWeek(ctx context.Context, week string) (TimeWeekView, error) {
	return s.getTimeWeek(ctx, week, true)
}

func (s *Service) getTimeWeek(ctx context.Context, week string, forceRefresh bool) (TimeWeekView, error) {
	if week == "" {
		week = CurrentWeek(s.loc)
	}
...
func (s *Service) LogTempoTime(ctx context.Context, input LogTimeRequest) (LogTimeResult, error) {
...
func (s *Service) tempoSettingsWithAuthor(ctx context.Context) (appsettings.Settings, string, error) {
	settings, err := s.settings.Load()
	if err != nil {
...
func (s *Service) fetchTempoAuthorAccountID(ctx context.Context, settings appsettings.Settings) (string, error) {
	client := jira.New(jira.Config{
		BaseURL:  settings.Jira.BaseURL,
		Email:    settings.Jira.Email,
		APIToken: settings.Jira.APIToken,
...
func (s *Service) cachedTimeWorklogs(ctx context.Context, accountID string, startDate string, endDate string) ([]TimeWorklog, bool, error) {
...
func (s *Service) timeWorklogsForRange(ctx context.Context, tempoClient *tempo.Client, accountID string, startDate string, endDate string) ([]TimeWorklog, error) {
